var GAME = {
  ...
  zombiesInc: 15+ Math.trunc(Math.random()*10)
};
...
var WEAPONS = [
  {cost: 0, owned: true, shopXpos:50, shopYpos:50, shopSize:1, fimage: 'Sprites\\fclub.png', image: 'Sprites\\club.png', name: "Club", class: "melee", cooldown: 60, angle: 45, clipSize: -1, ammoOwned: -1, ammoLeftInClip: -1, damage: 50*PLAYER_CHARACTER.strength, knockback: 20},
  {cost: 3, owned: false, shopXpos:150, shopYpos:50, shopSize:1, image: 'Sprites\\katana.png', name: "Katana", class : "melee", cooldown: 42, angle: 50, clipSize: -1, ammoOwned: -1, ammoLeftInClip: -1, damage: 104*PLAYER_CHARACTER.strength, knockback: 20},
  ...
  {cost: 25, owned: false, shopXpos:150, shopYpos:180, shopSize:1, image: 'Sprites\\sniperrifle.png', name: "Sniper", class: "ranged", cooldown: 60, bulletSpeed: 15, clipSize: 5, ammoOwned: 25, ammoLeftInClip: 5, damage: 200*Math.sqrt(PLAYER_CHARACTER.strength), knockback: 40, reload: 60},
  {cost: 100, owned: false, shopXpos:250, shopYpos:180, shopSize:1, image: 'Sprites\\excalibur.png', name: "Excalibur", class: "melee", cooldown: 30, angle: 67.5, clipSize: -1, ammoOwned: -1, ammoLeftInClip: -1, damage: 500*PLAYER_CHARACTER.strength*PLAYER_CHARACTER.strength , knockback: 20},
...
var TRAITS= [
{name: "Strength", image:'Sprites\\arm.png', shopXpos:380, shopYpos:240, shopSize:.6, level: 1},
{name: "Speed", image:'Sprites\\shoe.png', shopXpos:430, shopYpos:240, shopSize:.6, level: 1},
{name: "HP", image:'Sprites\\heart.png', shopXpos:480, shopYpos:240, shopSize:.6, level: 1},
{name: "Luck", image:'Sprites\\dna.png', shopXpos:530, shopYpos:240, shopSize:.6, level: 1}
]

var COSTS= [2,3,5,8,10,20];
